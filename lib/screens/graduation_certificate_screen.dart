...
class GraduationCertificateScreen extends StatefulWidget {
  @override
  _GraduationCertificateScreenState createState() => _GraduationCertificateScreenState();
}

class _GraduationCertificateScreenState extends State<GraduationCertificateScreen> {
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Your request for a "Graduation Certificate" has been successfully submitted.',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20,
