                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(
                                            child: Text(
                                              'What is the purpose of requesting your transcript? *',
                                              style: TextStyle(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(
                                            child: Text(
                                              'Which type of transcript do you need? eg. (Official-Unofficial-PDF-Printed copy) *',
                                              style: TextStyle(
                                                color: Colors.black.withOpacity(1),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Your request for a "Transcript" has been successfully submitted.',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20,
