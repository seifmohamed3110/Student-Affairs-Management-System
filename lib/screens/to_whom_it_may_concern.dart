...
class ToWhomItMayConcernScreen extends StatefulWidget {
  @override
  _ToWhomItMayConcernScreenState createState() => _ToWhomItMayConcernScreenState();
}

class _ToWhomItMayConcernScreenState extends State<ToWhomItMayConcernScreen> {
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                'Your request for a "To Whom It May Concern Letter" has been successfully submitted.',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20,
